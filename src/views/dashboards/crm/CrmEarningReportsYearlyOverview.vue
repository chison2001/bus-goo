  ...
  return [
    {
      ...
      series: [
        {
          data: [28, 10, 45, 38, 15, 30, 35, 30, 8, 12, 24, 10],
        },
      ],
    },
    {
      ...
      series: [
        {
          data: [35, 25, 15, 40, 42, 25, 48, 8, 30, 20, 30.4, 18],
        },
      ],
    },
    {
      ...
      series: [
        {
          data: [10, 22, 27, 33, 42, 32, 27, 22, 8, 13, 24, 18],
        },
      ],
    },
  ]
...
<template>
  <VCard
    ...
    :subtitle="$t('Tổng quan về thu nhập hàng năm')"
  >
    <VCardText>
      <VSlideGroup
        v-model="currentTab"
      ...
      >
        ...
        >
          <div
            style="block-size: 104px; inline-size: 130px;"
